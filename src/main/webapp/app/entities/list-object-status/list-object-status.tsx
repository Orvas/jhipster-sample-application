...
export type IListObjectStatusState = IPaginationBaseState;

export class ListObjectStatus extends React.Component<IListObjectStatusProps, IListObjectStatusState> {
  state: IListObjectStatusState = {
  ...
  render() {
    const { listObjectStatusList, match, totalItems } = this.props;
    return (
      <div>
            ...
            <tbody>
              {listObjectStatusList.map((listObjectStatus, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{listObjectStatus.isCurrentFlag}</td>
                  <td>{listObjectStatus.description}</td>
                  <td>
                    <TextFormat type="date" value={listObjectStatus.dateCreate} format={APP_DATE_FORMAT} />
                  </td>
                  <td>
                    <TextFormat type="date" value={listObjectStatus.dateEdit} format={APP_DATE_FORMAT} />
                  </td>
                  <td>{listObjectStatus.creator}</td>
                  <td>{listObjectStatus.editor}</td>
...
const mapStateToProps = ({ listObjectStatus }: IRootState) => ({
  ...
  totalItems: listObjectStatus.totalItems
});
