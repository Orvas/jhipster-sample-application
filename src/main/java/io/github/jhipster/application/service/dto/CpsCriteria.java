...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.Cps} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.CpsResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cps?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CpsCriteria implements Serializable, Criteria {
    ...
    public CpsCriteria(CpsCriteria other){
    ...
    @Override
    public CpsCriteria copy() {
        return new CpsCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CpsCriteria that = (CpsCriteria) o;
        return
