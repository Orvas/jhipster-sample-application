...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListClayType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListClayTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-clay-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListClayTypeCriteria implements Serializable, Criteria {
    ...
    public ListClayTypeCriteria(){
    }

    public ListClayTypeCriteria(ListClayTypeCriteria other){
    ...
    @Override
    public ListClayTypeCriteria copy() {
        return new ListClayTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListClayTypeCriteria that = (ListClayTypeCriteria) o;
        return
