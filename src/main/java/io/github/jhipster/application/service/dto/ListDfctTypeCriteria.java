...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListDfctType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListDfctTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-dfct-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListDfctTypeCriteria implements Serializable, Criteria {
    ...
    private LongFilter idGroupId;

    public ListDfctTypeCriteria(){
    }

    public ListDfctTypeCriteria(ListDfctTypeCriteria other){
        ...
        this.idGroupId = other.idGroupId == null ? null : other.idGroupId.copy();
    }

    @Override
    public ListDfctTypeCriteria copy() {
        return new ListDfctTypeCriteria(this);
    }
    ...
    public LongFilter getIdGroupId() {
        return idGroupId;
    }

    public void setIdGroupId(LongFilter idGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        final ListDfctTypeCriteria that = (ListDfctTypeCriteria) o;
        return
            ...
            Objects.equals(idGroupId, that.idGroupId);
    }
    ...
    public String toString() {
        return "ListDfctTypeCriteria{" +
                ...
                (idGroupId != null ? "idGroupId=" + idGroupId + ", " : "") +
            "}";
    }
