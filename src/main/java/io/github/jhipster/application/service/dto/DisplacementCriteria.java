...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.Displacement} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.DisplacementResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /displacements?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class DisplacementCriteria implements Serializable, Criteria {
    ...
    public DisplacementCriteria(){
    }

    public DisplacementCriteria(DisplacementCriteria other){
    ...
    @Override
    public DisplacementCriteria copy() {
        return new DisplacementCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DisplacementCriteria that = (DisplacementCriteria) o;
        return
