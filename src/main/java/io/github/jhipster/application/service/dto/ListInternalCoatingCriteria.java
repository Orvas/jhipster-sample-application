...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListInternalCoating} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListInternalCoatingResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-internal-coatings?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListInternalCoatingCriteria implements Serializable, Criteria {
    ...
    public ListInternalCoatingCriteria(){
    }

    public ListInternalCoatingCriteria(ListInternalCoatingCriteria other){
    ...
    @Override
    public ListInternalCoatingCriteria copy() {
        return new ListInternalCoatingCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListInternalCoatingCriteria that = (ListInternalCoatingCriteria) o;
        return
    ...
    public String toString() {
        return "ListInternalCoatingCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
