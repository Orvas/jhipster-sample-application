...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListWrkStatus} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListWrkStatusResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-wrk-statuses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListWrkStatusCriteria implements Serializable, Criteria {
    ...
    private LongFilter idWrkKindId;

    private LongFilter anodeHistId;

    public ListWrkStatusCriteria(){
    }

    public ListWrkStatusCriteria(ListWrkStatusCriteria other){
        ...
        this.idWrkKindId = other.idWrkKindId == null ? null : other.idWrkKindId.copy();
        this.anodeHistId = other.anodeHistId == null ? null : other.anodeHistId.copy();
    }

    @Override
    public ListWrkStatusCriteria copy() {
        return new ListWrkStatusCriteria(this);
    }
    ...
    public LongFilter getIdWrkKindId() {
        return idWrkKindId;
    }

    public void setIdWrkKindId(LongFilter idWrkKindId) {
        this.idWrkKindId = idWrkKindId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListWrkStatusCriteria that = (ListWrkStatusCriteria) o;
        return
            ...
            Objects.equals(idWrkKindId, that.idWrkKindId) &&
    ...
    public String toString() {
        return "ListWrkStatusCriteria{" +
                ...
                (idWrkKindId != null ? "idWrkKindId=" + idWrkKindId + ", " : "") +
