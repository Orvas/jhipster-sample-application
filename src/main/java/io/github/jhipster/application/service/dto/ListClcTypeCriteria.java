...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListClcType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListClcTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-clc-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListClcTypeCriteria implements Serializable, Criteria {
    ...
    public ListClcTypeCriteria(){
    }

    public ListClcTypeCriteria(ListClcTypeCriteria other){
    ...
    @Override
    public ListClcTypeCriteria copy() {
        return new ListClcTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListClcTypeCriteria that = (ListClcTypeCriteria) o;
        return
