...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListIliPigType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListIliPigTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-ili-pig-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListIliPigTypeCriteria implements Serializable, Criteria {
    ...
    public ListIliPigTypeCriteria(){
    }

    public ListIliPigTypeCriteria(ListIliPigTypeCriteria other){
    ...
    @Override
    public ListIliPigTypeCriteria copy() {
        return new ListIliPigTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListIliPigTypeCriteria that = (ListIliPigTypeCriteria) o;
        return
