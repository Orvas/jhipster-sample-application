...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListSoilType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListSoilTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-soil-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListSoilTypeCriteria implements Serializable, Criteria {
    ...
    public ListSoilTypeCriteria(){
    }

    public ListSoilTypeCriteria(ListSoilTypeCriteria other){
    ...
    @Override
    public ListSoilTypeCriteria copy() {
        return new ListSoilTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListSoilTypeCriteria that = (ListSoilTypeCriteria) o;
        return
