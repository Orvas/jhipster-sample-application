...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.BendHist} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.BendHistResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /bend-hists?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class BendHistCriteria implements Serializable, Criteria {
    ...
    private BigDecimalFilter radius;
    ...
    public BendHistCriteria(){
    }

    public BendHistCriteria(BendHistCriteria other){
    ...
    @Override
    public BendHistCriteria copy() {
        return new BendHistCriteria(this);
    }
    ...
    public BigDecimalFilter getRadius() {
        return radius;
    }

    public void setRadius(BigDecimalFilter radius) {
        this.radius = radius;
    }
    ...
    public boolean equals(Object o) {
        ...
        final BendHistCriteria that = (BendHistCriteria) o;
        return
