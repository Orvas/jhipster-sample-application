...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListMaterial} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListMaterialResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-materials?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListMaterialCriteria implements Serializable, Criteria {
    ...
    public ListMaterialCriteria(ListMaterialCriteria other){
    ...
    @Override
    public ListMaterialCriteria copy() {
        return new ListMaterialCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListMaterialCriteria that = (ListMaterialCriteria) o;
        return
