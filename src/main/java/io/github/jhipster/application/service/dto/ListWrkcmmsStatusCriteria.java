...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListWrkcmmsStatus} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListWrkcmmsStatusResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-wrkcmms-statuses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListWrkcmmsStatusCriteria implements Serializable, Criteria {
    ...
    public ListWrkcmmsStatusCriteria(){
    }

    public ListWrkcmmsStatusCriteria(ListWrkcmmsStatusCriteria other){
    ...
    @Override
    public ListWrkcmmsStatusCriteria copy() {
        return new ListWrkcmmsStatusCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListWrkcmmsStatusCriteria that = (ListWrkcmmsStatusCriteria) o;
        return
    ...
    public String toString() {
        return "ListWrkcmmsStatusCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
