...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListValveManufacturer} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListValveManufacturerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-valve-manufacturers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListValveManufacturerCriteria implements Serializable, Criteria {
    ...
    public ListValveManufacturerCriteria(){
    }

    public ListValveManufacturerCriteria(ListValveManufacturerCriteria other){
    ...
    @Override
    public ListValveManufacturerCriteria copy() {
        return new ListValveManufacturerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListValveManufacturerCriteria that = (ListValveManufacturerCriteria) o;
        return
    ...
    public String toString() {
        return "ListValveManufacturerCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
