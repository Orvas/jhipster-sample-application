...
/**
 * A DTO for the {@link io.github.jhipster.application.domain.ListSteelGrade} entity.
 */
public class ListSteelGradeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ListSteelGradeDTO listSteelGradeDTO = (ListSteelGradeDTO) o;
        if (listSteelGradeDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), listSteelGradeDTO.getId());
    }
