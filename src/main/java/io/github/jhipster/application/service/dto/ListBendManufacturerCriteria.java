...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListBendManufacturer} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListBendManufacturerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-bend-manufacturers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListBendManufacturerCriteria implements Serializable, Criteria {
    ...
    public ListBendManufacturerCriteria(){
    }

    public ListBendManufacturerCriteria(ListBendManufacturerCriteria other){
    ...
    @Override
    public ListBendManufacturerCriteria copy() {
        return new ListBendManufacturerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListBendManufacturerCriteria that = (ListBendManufacturerCriteria) o;
        return
    ...
    public String toString() {
        return "ListBendManufacturerCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
