...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListInternalPressUcase} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListInternalPressUcaseResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-internal-press-ucases?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListInternalPressUcaseCriteria implements Serializable, Criteria {
    ...
    public ListInternalPressUcaseCriteria(){
    }

    public ListInternalPressUcaseCriteria(ListInternalPressUcaseCriteria other){
    ...
    @Override
    public ListInternalPressUcaseCriteria copy() {
        return new ListInternalPressUcaseCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListInternalPressUcaseCriteria that = (ListInternalPressUcaseCriteria) o;
        return
    ...
    public String toString() {
        return "ListInternalPressUcaseCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
