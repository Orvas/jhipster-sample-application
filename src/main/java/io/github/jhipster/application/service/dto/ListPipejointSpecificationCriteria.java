...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListPipejointSpecification} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListPipejointSpecificationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-pipejoint-specifications?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListPipejointSpecificationCriteria implements Serializable, Criteria {
    ...
    public ListPipejointSpecificationCriteria(){
    }

    public ListPipejointSpecificationCriteria(ListPipejointSpecificationCriteria other){
    ...
    @Override
    public ListPipejointSpecificationCriteria copy() {
        return new ListPipejointSpecificationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListPipejointSpecificationCriteria that = (ListPipejointSpecificationCriteria) o;
        return
    ...
    public String toString() {
        return "ListPipejointSpecificationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
