...
/**
 * A DTO for the {@link io.github.jhipster.application.domain.ValveHist} entity.
 */
@ApiModel(description = "Valve. Time-dependent attribute table. One table  rows corresponds to one valve and time period")
public class ValveHistDTO implements Serializable {
    ...
    public void setIdTypeId(Long listValveTypeId) {
        this.idTypeId = listValveTypeId;
    }
    ...
    public void setIdManufacturerId(Long listValveManufacturerId) {
        this.idManufacturerId = listValveManufacturerId;
    }
    ...
    public void setIdSpecificationId(Long listValveSpecificationId) {
        this.idSpecificationId = listValveSpecificationId;
    }
    ...
    public void setIdFunctionId(Long listValveFunctionId) {
        this.idFunctionId = listValveFunctionId;
    }
    ...
    public boolean equals(Object o) {
        ...
        ValveHistDTO valveHistDTO = (ValveHistDTO) o;
        if (valveHistDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), valveHistDTO.getId());
    }
