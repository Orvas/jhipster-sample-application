...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListRiskConsequence} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListRiskConsequenceResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-risk-consequences?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListRiskConsequenceCriteria implements Serializable, Criteria {
    ...
    private StringFilter safety;

    private StringFilter commerImpact;
    ...
    public ListRiskConsequenceCriteria(){
    }

    public ListRiskConsequenceCriteria(ListRiskConsequenceCriteria other){
        this.id = other.id == null ? null : other.id.copy();
        this.code = other.code == null ? null : other.code.copy();
        this.name = other.name == null ? null : other.name.copy();
        this.fullName = other.fullName == null ? null : other.fullName.copy();
        this.safety = other.safety == null ? null : other.safety.copy();
        this.commerImpact = other.commerImpact == null ? null : other.commerImpact.copy();
    ...
    @Override
    public ListRiskConsequenceCriteria copy() {
        return new ListRiskConsequenceCriteria(this);
    }
    ...
    public StringFilter getSafety() {
        return safety;
    }

    public void setSafety(StringFilter safety) {
        this.safety = safety;
    }

    public StringFilter getCommerImpact() {
        return commerImpact;
    }

    public void setCommerImpact(StringFilter commerImpact) {
        this.commerImpact = commerImpact;
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListRiskConsequenceCriteria that = (ListRiskConsequenceCriteria) o;
        return
            ...
            Objects.equals(commerImpact, that.commerImpact) &&
    ...
    public String toString() {
        return "ListRiskConsequenceCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
                (fullName != null ? "fullName=" + fullName + ", " : "") +
                (safety != null ? "safety=" + safety + ", " : "") +
                (commerImpact != null ? "commerImpact=" + commerImpact + ", " : "") +
