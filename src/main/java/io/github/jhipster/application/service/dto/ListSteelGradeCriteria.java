...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListSteelGrade} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListSteelGradeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-steel-grades?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListSteelGradeCriteria implements Serializable, Criteria {
    ...
    private BigDecimalFilter steelDensity;

    private BigDecimalFilter thermExpCoef;
    ...
    public ListSteelGradeCriteria(){
    }

    public ListSteelGradeCriteria(ListSteelGradeCriteria other){
        this.id = other.id == null ? null : other.id.copy();
        this.code = other.code == null ? null : other.code.copy();
        this.name = other.name == null ? null : other.name.copy();
        this.fullName = other.fullName == null ? null : other.fullName.copy();
        this.steelDensity = other.steelDensity == null ? null : other.steelDensity.copy();
        this.thermExpCoef = other.thermExpCoef == null ? null : other.thermExpCoef.copy();
    ...
    @Override
    public ListSteelGradeCriteria copy() {
        return new ListSteelGradeCriteria(this);
    }
    ...
    public BigDecimalFilter getSteelDensity() {
        return steelDensity;
    }

    public void setSteelDensity(BigDecimalFilter steelDensity) {
        this.steelDensity = steelDensity;
    }

    public BigDecimalFilter getThermExpCoef() {
        return thermExpCoef;
    }

    public void setThermExpCoef(BigDecimalFilter thermExpCoef) {
    ...
    public boolean equals(Object o) {
        ...
        final ListSteelGradeCriteria that = (ListSteelGradeCriteria) o;
        return
            Objects.equals(id, that.id) &&
            Objects.equals(code, that.code) &&
            Objects.equals(name, that.name) &&
            Objects.equals(fullName, that.fullName) &&
            Objects.equals(steelDensity, that.steelDensity) &&
            Objects.equals(thermExpCoef, that.thermExpCoef) &&
    ...
    public String toString() {
        return "ListSteelGradeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
                (fullName != null ? "fullName=" + fullName + ", " : "") +
                (steelDensity != null ? "steelDensity=" + steelDensity + ", " : "") +
                (thermExpCoef != null ? "thermExpCoef=" + thermExpCoef + ", " : "") +
