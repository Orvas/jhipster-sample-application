...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListBoundaryCondUcase} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListBoundaryCondUcaseResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-boundary-cond-ucases?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListBoundaryCondUcaseCriteria implements Serializable, Criteria {
    ...
    public ListBoundaryCondUcaseCriteria(){
    }

    public ListBoundaryCondUcaseCriteria(ListBoundaryCondUcaseCriteria other){
    ...
    @Override
    public ListBoundaryCondUcaseCriteria copy() {
        return new ListBoundaryCondUcaseCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListBoundaryCondUcaseCriteria that = (ListBoundaryCondUcaseCriteria) o;
        return
    ...
    public String toString() {
        return "ListBoundaryCondUcaseCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
