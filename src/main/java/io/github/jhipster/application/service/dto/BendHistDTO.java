...
/**
 * A DTO for the {@link io.github.jhipster.application.domain.BendHist} entity.
 */
@ApiModel(description = "Time-dependent attribute table. One table  rows corresponds to one bend and time period")
public class BendHistDTO implements Serializable {
    ...
    public void setIdTypeId(Long listBendTypeId) {
        this.idTypeId = listBendTypeId;
    }
    ...
    public void setIdManufacturerId(Long listBendManufacturerId) {
        this.idManufacturerId = listBendManufacturerId;
    }
    ...
    public void setIdSpecificationId(Long listBendSpecificationId) {
        this.idSpecificationId = listBendSpecificationId;
    }
    ...
    public boolean equals(Object o) {
        ...
        BendHistDTO bendHistDTO = (BendHistDTO) o;
        if (bendHistDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), bendHistDTO.getId());
    }
