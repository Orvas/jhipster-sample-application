...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListSandType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListSandTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-sand-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListSandTypeCriteria implements Serializable, Criteria {
    ...
    public ListSandTypeCriteria(){
    }

    public ListSandTypeCriteria(ListSandTypeCriteria other){
    ...
    @Override
    public ListSandTypeCriteria copy() {
        return new ListSandTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListSandTypeCriteria that = (ListSandTypeCriteria) o;
        return
