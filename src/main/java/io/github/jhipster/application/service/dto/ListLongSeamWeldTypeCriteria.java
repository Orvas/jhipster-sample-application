...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListLongSeamWeldType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListLongSeamWeldTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-long-seam-weld-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListLongSeamWeldTypeCriteria implements Serializable, Criteria {
    ...
    public ListLongSeamWeldTypeCriteria(){
    }

    public ListLongSeamWeldTypeCriteria(ListLongSeamWeldTypeCriteria other){
    ...
    @Override
    public ListLongSeamWeldTypeCriteria copy() {
        return new ListLongSeamWeldTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListLongSeamWeldTypeCriteria that = (ListLongSeamWeldTypeCriteria) o;
        return
    ...
    public String toString() {
        return "ListLongSeamWeldTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
