...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListBucklarrType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListBucklarrTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-bucklarr-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListBucklarrTypeCriteria implements Serializable, Criteria {
    ...
    public ListBucklarrTypeCriteria(){
    }

    public ListBucklarrTypeCriteria(ListBucklarrTypeCriteria other){
    ...
    @Override
    public ListBucklarrTypeCriteria copy() {
        return new ListBucklarrTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListBucklarrTypeCriteria that = (ListBucklarrTypeCriteria) o;
        return
    ...
    public String toString() {
        return "ListBucklarrTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
