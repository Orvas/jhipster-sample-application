...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListTeeManufacturer} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListTeeManufacturerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-tee-manufacturers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListTeeManufacturerCriteria implements Serializable, Criteria {
    ...
    public ListTeeManufacturerCriteria(){
    }

    public ListTeeManufacturerCriteria(ListTeeManufacturerCriteria other){
    ...
    @Override
    public ListTeeManufacturerCriteria copy() {
        return new ListTeeManufacturerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListTeeManufacturerCriteria that = (ListTeeManufacturerCriteria) o;
        return
    ...
    public String toString() {
        return "ListTeeManufacturerCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
