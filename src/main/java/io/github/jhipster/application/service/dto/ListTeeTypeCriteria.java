...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListTeeType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListTeeTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-tee-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListTeeTypeCriteria implements Serializable, Criteria {
    ...
    public ListTeeTypeCriteria(){
    }

    public ListTeeTypeCriteria(ListTeeTypeCriteria other){
    ...
    @Override
    public ListTeeTypeCriteria copy() {
        return new ListTeeTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListTeeTypeCriteria that = (ListTeeTypeCriteria) o;
        return
