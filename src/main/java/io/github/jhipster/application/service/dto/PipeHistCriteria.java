...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.PipeHist} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.PipeHistResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /pipe-hists?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PipeHistCriteria implements Serializable, Criteria {
    ...
    private StringFilter designCoord;
    ...
    public PipeHistCriteria(){
    }

    public PipeHistCriteria(PipeHistCriteria other){
    ...
    @Override
    public PipeHistCriteria copy() {
        return new PipeHistCriteria(this);
    }
    ...
    public StringFilter getDesignCoord() {
        return designCoord;
    }

    public void setDesignCoord(StringFilter designCoord) {
    ...
    public boolean equals(Object o) {
        ...
        final PipeHistCriteria that = (PipeHistCriteria) o;
        return
