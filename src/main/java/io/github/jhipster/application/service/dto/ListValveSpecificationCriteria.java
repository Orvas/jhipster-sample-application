...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListValveSpecification} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListValveSpecificationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-valve-specifications?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListValveSpecificationCriteria implements Serializable, Criteria {
    ...
    public ListValveSpecificationCriteria(){
    }

    public ListValveSpecificationCriteria(ListValveSpecificationCriteria other){
    ...
    @Override
    public ListValveSpecificationCriteria copy() {
        return new ListValveSpecificationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListValveSpecificationCriteria that = (ListValveSpecificationCriteria) o;
        return
    ...
    public String toString() {
        return "ListValveSpecificationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
