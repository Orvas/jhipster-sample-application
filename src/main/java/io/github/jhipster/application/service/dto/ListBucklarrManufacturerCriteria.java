...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListBucklarrManufacturer} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListBucklarrManufacturerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-bucklarr-manufacturers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListBucklarrManufacturerCriteria implements Serializable, Criteria {
    ...
    public ListBucklarrManufacturerCriteria(){
    }

    public ListBucklarrManufacturerCriteria(ListBucklarrManufacturerCriteria other){
    ...
    @Override
    public ListBucklarrManufacturerCriteria copy() {
        return new ListBucklarrManufacturerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListBucklarrManufacturerCriteria that = (ListBucklarrManufacturerCriteria) o;
        return
    ...
    public String toString() {
        return "ListBucklarrManufacturerCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
