...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListValveFunction} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListValveFunctionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-valve-functions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListValveFunctionCriteria implements Serializable, Criteria {
    ...
    public ListValveFunctionCriteria(){
    }

    public ListValveFunctionCriteria(ListValveFunctionCriteria other){
    ...
    @Override
    public ListValveFunctionCriteria copy() {
        return new ListValveFunctionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListValveFunctionCriteria that = (ListValveFunctionCriteria) o;
        return
    ...
    public String toString() {
        return "ListValveFunctionCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
