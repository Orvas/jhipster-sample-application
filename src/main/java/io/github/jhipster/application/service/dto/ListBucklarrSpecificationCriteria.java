...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListBucklarrSpecification} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListBucklarrSpecificationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-bucklarr-specifications?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListBucklarrSpecificationCriteria implements Serializable, Criteria {
    ...
    public ListBucklarrSpecificationCriteria(){
    }

    public ListBucklarrSpecificationCriteria(ListBucklarrSpecificationCriteria other){
    ...
    @Override
    public ListBucklarrSpecificationCriteria copy() {
        return new ListBucklarrSpecificationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListBucklarrSpecificationCriteria that = (ListBucklarrSpecificationCriteria) o;
        return
    ...
    public String toString() {
        return "ListBucklarrSpecificationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
