...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListNominalWallThickness} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListNominalWallThicknessResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-nominal-wall-thicknesses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListNominalWallThicknessCriteria implements Serializable, Criteria {
    ...
    public ListNominalWallThicknessCriteria(){
    }

    public ListNominalWallThicknessCriteria(ListNominalWallThicknessCriteria other){
    ...
    @Override
    public ListNominalWallThicknessCriteria copy() {
        return new ListNominalWallThicknessCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListNominalWallThicknessCriteria that = (ListNominalWallThicknessCriteria) o;
        return
    ...
    public String toString() {
        return "ListNominalWallThicknessCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
