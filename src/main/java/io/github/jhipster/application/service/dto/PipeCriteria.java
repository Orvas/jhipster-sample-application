...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.Pipe} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.PipeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /pipes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PipeCriteria implements Serializable, Criteria {
    ...
    public PipeCriteria(PipeCriteria other){
    ...
    @Override
    public PipeCriteria copy() {
        return new PipeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PipeCriteria that = (PipeCriteria) o;
        return
