...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListWrkPurpose} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListWrkPurposeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-wrk-purposes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListWrkPurposeCriteria implements Serializable, Criteria {
    ...
    public ListWrkPurposeCriteria(){
    }

    public ListWrkPurposeCriteria(ListWrkPurposeCriteria other){
    ...
    @Override
    public ListWrkPurposeCriteria copy() {
        return new ListWrkPurposeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListWrkPurposeCriteria that = (ListWrkPurposeCriteria) o;
        return
