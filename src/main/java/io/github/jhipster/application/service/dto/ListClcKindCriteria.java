...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListClcKind} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListClcKindResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-clc-kinds?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListClcKindCriteria implements Serializable, Criteria {
    ...
    public ListClcKindCriteria(){
    }

    public ListClcKindCriteria(ListClcKindCriteria other){
    ...
    @Override
    public ListClcKindCriteria copy() {
        return new ListClcKindCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListClcKindCriteria that = (ListClcKindCriteria) o;
        return
