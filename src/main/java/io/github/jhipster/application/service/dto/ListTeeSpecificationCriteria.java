...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListTeeSpecification} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListTeeSpecificationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-tee-specifications?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListTeeSpecificationCriteria implements Serializable, Criteria {
    ...
    public ListTeeSpecificationCriteria(){
    }

    public ListTeeSpecificationCriteria(ListTeeSpecificationCriteria other){
    ...
    @Override
    public ListTeeSpecificationCriteria copy() {
        return new ListTeeSpecificationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListTeeSpecificationCriteria that = (ListTeeSpecificationCriteria) o;
        return
    ...
    public String toString() {
        return "ListTeeSpecificationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
