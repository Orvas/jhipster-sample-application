...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListAnodeBraceleteType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListAnodeBraceleteTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-anode-bracelete-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListAnodeBraceleteTypeCriteria implements Serializable, Criteria {
    ...
    public ListAnodeBraceleteTypeCriteria(){
    }

    public ListAnodeBraceleteTypeCriteria(ListAnodeBraceleteTypeCriteria other){
    ...
    @Override
    public ListAnodeBraceleteTypeCriteria copy() {
        return new ListAnodeBraceleteTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListAnodeBraceleteTypeCriteria that = (ListAnodeBraceleteTypeCriteria) o;
        return
    ...
    public String toString() {
        return "ListAnodeBraceleteTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
