...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListRiskProbability} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListRiskProbabilityResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-risk-probabilities?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListRiskProbabilityCriteria implements Serializable, Criteria {
    ...
    public ListRiskProbabilityCriteria(){
    }

    public ListRiskProbabilityCriteria(ListRiskProbabilityCriteria other){
    ...
    @Override
    public ListRiskProbabilityCriteria copy() {
        return new ListRiskProbabilityCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListRiskProbabilityCriteria that = (ListRiskProbabilityCriteria) o;
        return
    ...
    public String toString() {
        return "ListRiskProbabilityCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
