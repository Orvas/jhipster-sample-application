...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListDfctPosType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListDfctPosTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-dfct-pos-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListDfctPosTypeCriteria implements Serializable, Criteria {
    ...
    public ListDfctPosTypeCriteria(){
    }

    public ListDfctPosTypeCriteria(ListDfctPosTypeCriteria other){
    ...
    @Override
    public ListDfctPosTypeCriteria copy() {
        return new ListDfctPosTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListDfctPosTypeCriteria that = (ListDfctPosTypeCriteria) o;
        return
    ...
    public String toString() {
        return "ListDfctPosTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
