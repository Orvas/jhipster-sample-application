...
/**
 * A DTO for the {@link io.github.jhipster.application.domain.Pipe} entity.
 */
...
public class PipeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        PipeDTO pipeDTO = (PipeDTO) o;
        if (pipeDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), pipeDTO.getId());
    }
