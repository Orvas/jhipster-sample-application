...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListDfctGroup} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListDfctGroupResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-dfct-groups?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListDfctGroupCriteria implements Serializable, Criteria {
    ...
    private LongFilter listDfctTypeId;

    public ListDfctGroupCriteria(){
    }

    public ListDfctGroupCriteria(ListDfctGroupCriteria other){
        ...
        this.listDfctTypeId = other.listDfctTypeId == null ? null : other.listDfctTypeId.copy();
    }

    @Override
    public ListDfctGroupCriteria copy() {
        return new ListDfctGroupCriteria(this);
    }
    ...
    public LongFilter getListDfctTypeId() {
        return listDfctTypeId;
    }

    public void setListDfctTypeId(LongFilter listDfctTypeId) {
        this.listDfctTypeId = listDfctTypeId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListDfctGroupCriteria that = (ListDfctGroupCriteria) o;
        return
            ...
            Objects.equals(listDfctTypeId, that.listDfctTypeId);
    }
    ...
    public String toString() {
        return "ListDfctGroupCriteria{" +
                ...
                (listDfctTypeId != null ? "listDfctTypeId=" + listDfctTypeId + ", " : "") +
            "}";
    }
