...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListThreat} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListThreatResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-threats?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListThreatCriteria implements Serializable, Criteria {
    ...
    public ListThreatCriteria(){
    }

    public ListThreatCriteria(ListThreatCriteria other){
    ...
    @Override
    public ListThreatCriteria copy() {
        return new ListThreatCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListThreatCriteria that = (ListThreatCriteria) o;
        return
