...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListBendType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListBendTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-bend-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListBendTypeCriteria implements Serializable, Criteria {
    ...
    public ListBendTypeCriteria(){
    }

    public ListBendTypeCriteria(ListBendTypeCriteria other){
    ...
    @Override
    public ListBendTypeCriteria copy() {
        return new ListBendTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListBendTypeCriteria that = (ListBendTypeCriteria) o;
        return
