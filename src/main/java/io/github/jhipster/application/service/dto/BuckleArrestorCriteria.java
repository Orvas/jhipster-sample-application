...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.BuckleArrestor} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.BuckleArrestorResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /buckle-arrestors?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class BuckleArrestorCriteria implements Serializable, Criteria {
    ...
    public BuckleArrestorCriteria(){
    }

    public BuckleArrestorCriteria(BuckleArrestorCriteria other){
    ...
    @Override
    public BuckleArrestorCriteria copy() {
        return new BuckleArrestorCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final BuckleArrestorCriteria that = (BuckleArrestorCriteria) o;
        return
