...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListPipeSpecification} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListPipeSpecificationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-pipe-specifications?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListPipeSpecificationCriteria implements Serializable, Criteria {
    ...
    public ListPipeSpecificationCriteria(){
    }

    public ListPipeSpecificationCriteria(ListPipeSpecificationCriteria other){
    ...
    @Override
    public ListPipeSpecificationCriteria copy() {
        return new ListPipeSpecificationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListPipeSpecificationCriteria that = (ListPipeSpecificationCriteria) o;
        return
    ...
    public String toString() {
        return "ListPipeSpecificationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
