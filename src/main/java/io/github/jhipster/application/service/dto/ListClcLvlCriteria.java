...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListClcLvl} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListClcLvlResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-clc-lvls?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListClcLvlCriteria implements Serializable, Criteria {
    ...
    public ListClcLvlCriteria(){
    }

    public ListClcLvlCriteria(ListClcLvlCriteria other){
    ...
    @Override
    public ListClcLvlCriteria copy() {
        return new ListClcLvlCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListClcLvlCriteria that = (ListClcLvlCriteria) o;
        return
