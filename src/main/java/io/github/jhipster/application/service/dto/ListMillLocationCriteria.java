...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListMillLocation} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListMillLocationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-mill-locations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListMillLocationCriteria implements Serializable, Criteria {
    ...
    public ListMillLocationCriteria(){
    }

    public ListMillLocationCriteria(ListMillLocationCriteria other){
    ...
    @Override
    public ListMillLocationCriteria copy() {
        return new ListMillLocationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListMillLocationCriteria that = (ListMillLocationCriteria) o;
        return
    ...
    public String toString() {
        return "ListMillLocationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
