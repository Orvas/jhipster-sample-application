...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListSafetyClass} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListSafetyClassResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-safety-classes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListSafetyClassCriteria implements Serializable, Criteria {
    ...
    public ListSafetyClassCriteria(){
    }

    public ListSafetyClassCriteria(ListSafetyClassCriteria other){
    ...
    @Override
    public ListSafetyClassCriteria copy() {
        return new ListSafetyClassCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListSafetyClassCriteria that = (ListSafetyClassCriteria) o;
        return
    ...
    public String toString() {
        return "ListSafetyClassCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
