...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.LaunchReceiver} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.LaunchReceiverResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /launch-receivers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LaunchReceiverCriteria implements Serializable, Criteria {
    ...
    public LaunchReceiverCriteria(){
    }

    public LaunchReceiverCriteria(LaunchReceiverCriteria other){
    ...
    @Override
    public LaunchReceiverCriteria copy() {
        return new LaunchReceiverCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LaunchReceiverCriteria that = (LaunchReceiverCriteria) o;
        return
