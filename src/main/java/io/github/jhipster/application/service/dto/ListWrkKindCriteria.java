...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListWrkKind} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListWrkKindResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-wrk-kinds?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListWrkKindCriteria implements Serializable, Criteria {
    ...
    private LongFilter listWrkStatusId;

    public ListWrkKindCriteria(){
    }

    public ListWrkKindCriteria(ListWrkKindCriteria other){
        ...
        this.listWrkStatusId = other.listWrkStatusId == null ? null : other.listWrkStatusId.copy();
    }

    @Override
    public ListWrkKindCriteria copy() {
        return new ListWrkKindCriteria(this);
    }
    ...
    public LongFilter getListWrkStatusId() {
        return listWrkStatusId;
    }

    public void setListWrkStatusId(LongFilter listWrkStatusId) {
        this.listWrkStatusId = listWrkStatusId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListWrkKindCriteria that = (ListWrkKindCriteria) o;
        return
            ...
            Objects.equals(listWrkStatusId, that.listWrkStatusId);
    }
    ...
    public String toString() {
        return "ListWrkKindCriteria{" +
                ...
                (listWrkStatusId != null ? "listWrkStatusId=" + listWrkStatusId + ", " : "") +
            "}";
    }
