...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListEnvPoint} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListEnvPointResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-env-points?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListEnvPointCriteria implements Serializable, Criteria {
    ...
    public ListEnvPointCriteria(){
    }

    public ListEnvPointCriteria(ListEnvPointCriteria other){
    ...
    @Override
    public ListEnvPointCriteria copy() {
        return new ListEnvPointCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListEnvPointCriteria that = (ListEnvPointCriteria) o;
        return
