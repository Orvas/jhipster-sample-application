...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListValveType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListValveTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-valve-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListValveTypeCriteria implements Serializable, Criteria {
    ...
    public ListValveTypeCriteria(){
    }

    public ListValveTypeCriteria(ListValveTypeCriteria other){
    ...
    @Override
    public ListValveTypeCriteria copy() {
        return new ListValveTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListValveTypeCriteria that = (ListValveTypeCriteria) o;
        return
