...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListPipeManufacturer} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListPipeManufacturerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-pipe-manufacturers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListPipeManufacturerCriteria implements Serializable, Criteria {
    ...
    public ListPipeManufacturerCriteria(){
    }

    public ListPipeManufacturerCriteria(ListPipeManufacturerCriteria other){
    ...
    @Override
    public ListPipeManufacturerCriteria copy() {
        return new ListPipeManufacturerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListPipeManufacturerCriteria that = (ListPipeManufacturerCriteria) o;
        return
    ...
    public String toString() {
        return "ListPipeManufacturerCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
