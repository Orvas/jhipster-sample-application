...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListEffAxforceUcase} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListEffAxforceUcaseResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-eff-axforce-ucases?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListEffAxforceUcaseCriteria implements Serializable, Criteria {
    ...
    public ListEffAxforceUcaseCriteria(){
    }

    public ListEffAxforceUcaseCriteria(ListEffAxforceUcaseCriteria other){
    ...
    @Override
    public ListEffAxforceUcaseCriteria copy() {
        return new ListEffAxforceUcaseCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListEffAxforceUcaseCriteria that = (ListEffAxforceUcaseCriteria) o;
        return
    ...
    public String toString() {
        return "ListEffAxforceUcaseCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
