...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListMinpressUcase} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListMinpressUcaseResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-minpress-ucases?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListMinpressUcaseCriteria implements Serializable, Criteria {
    ...
    public ListMinpressUcaseCriteria(){
    }

    public ListMinpressUcaseCriteria(ListMinpressUcaseCriteria other){
    ...
    @Override
    public ListMinpressUcaseCriteria copy() {
        return new ListMinpressUcaseCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListMinpressUcaseCriteria that = (ListMinpressUcaseCriteria) o;
        return
    ...
    public String toString() {
        return "ListMinpressUcaseCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
