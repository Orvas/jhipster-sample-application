...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListClcResult} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListClcResultResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-clc-results?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListClcResultCriteria implements Serializable, Criteria {
    ...
    public ListClcResultCriteria(){
    }

    public ListClcResultCriteria(ListClcResultCriteria other){
    ...
    @Override
    public ListClcResultCriteria copy() {
        return new ListClcResultCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListClcResultCriteria that = (ListClcResultCriteria) o;
        return
