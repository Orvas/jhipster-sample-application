...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListFabricationType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListFabricationTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-fabrication-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListFabricationTypeCriteria implements Serializable, Criteria {
    ...
    public ListFabricationTypeCriteria(){
    }

    public ListFabricationTypeCriteria(ListFabricationTypeCriteria other){
    ...
    @Override
    public ListFabricationTypeCriteria copy() {
        return new ListFabricationTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListFabricationTypeCriteria that = (ListFabricationTypeCriteria) o;
        return
    ...
    public String toString() {
        return "ListFabricationTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
