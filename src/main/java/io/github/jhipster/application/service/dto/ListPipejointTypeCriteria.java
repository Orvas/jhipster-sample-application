...
/**
 * Criteria class for the {@link io.github.jhipster.application.domain.ListPipejointType} entity. This class is used
 * in {@link io.github.jhipster.application.web.rest.ListPipejointTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /list-pipejoint-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListPipejointTypeCriteria implements Serializable, Criteria {
    ...
    public ListPipejointTypeCriteria(){
    }

    public ListPipejointTypeCriteria(ListPipejointTypeCriteria other){
    ...
    @Override
    public ListPipejointTypeCriteria copy() {
        return new ListPipejointTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListPipejointTypeCriteria that = (ListPipejointTypeCriteria) o;
        return
    ...
    public String toString() {
        return "ListPipejointTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (code != null ? "code=" + code + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
